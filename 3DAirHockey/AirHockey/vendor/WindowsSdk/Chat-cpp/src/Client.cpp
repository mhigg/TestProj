...
#	pragma warning(pop)
		...
		/** @fn template<typename Ftype> bool Client::opSendPrivateMessage(const Common::JString& userName, Ftype message, bool encrypt=false)
		...
		/** @fn template<typename Ftype> bool Client::opSendPrivateMessage(const Common::JString& userName, Ftype pMessageArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize, bool encrypt=false)
		    @overload
		    @param userName user name
		    @param pMessageArray message to send
			@param arrSize the number of elements in pParameterArray
		...
		/** @fn template<typename Ftype> bool Client::opSendPrivateMessage(const Common::JString& userName, Ftype pMessageArray, const short* pArrSizes, bool encrypt=false)
			@overload
		    @param userName user name
		    @param pMessageArray message to send
			@param pArrSizes an array holding the number of elements for each dimension of pParameterArray
		...
		/** @fn template<typename Ftype> bool Client::opSetOnlineStatus(int status, Ftype message)
			@overload
		...
		/** @fn template<typename Ftype> bool Client::opSetOnlineStatus(int status, Ftype pMessageArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize)
		    @overload
		    @param status predefined states are in namespace UserStatus. Other values can be used at will
		...
		/** @fn template<typename Ftype> bool Client::opSetOnlineStatus(int status, Ftype pMessageArray, const short* pArrSizes)
		    @overload
		    @param status predefined states are in namespace UserStatus. Other values can be used at will
		    @param pMessageArray optional status message
			@param pArrSizes an array holding the number of elements for each dimension of pParameterArray
