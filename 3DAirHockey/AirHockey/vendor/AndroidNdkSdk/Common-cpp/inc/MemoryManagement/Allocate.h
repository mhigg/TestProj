	...
	namespace Common
	{
		namespace MemoryManagement
		{
			...
			/**
			   ...
			   (friend-/subclass-)access or if the constructor takes a mix of const and non-const parameters (the template version requires that either all of the parameters of the constructor are const or none of them).
